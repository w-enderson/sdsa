...
data_dry_climates = pd.read_csv('./datasets/{}.csv'.format('dry_climates')) 
data_dry_climates['banco de dados'] = repeat('dry_climates', repeats=len(data_dry_climates))
data_european_climates = pd.read_csv('./datasets/{}.csv'.format('european_climates')) 
data_european_climates['banco de dados'] = repeat('european_climates', repeats=len(data_european_climates))
...
results_ivabc = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('ivabc'))
results_sdsa = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa'))
results_sdsa_lr = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_lr'))
results_sdsa_lr_not_update = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_lr_not_update'))
results_sdsa_not_update = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_not_update'))
results_sdsa_rf = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_rf'))
results_sdsa_rf_not_update = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_rf_not_update'))
results_sdsa_svc = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_svc'))
results_sdsa_svc_not_update = pd.read_csv('./results_test/{}/climates,dry_climates,european_climates,mushroom.csv'.format('sdsa_svc_not_update'))
